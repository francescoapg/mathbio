...
El enlace con Topología se da de la siguiente manera, si <img src="https://render.githubusercontent.com/render/math?math=\large (X,\mathcal{T})"> es un espacio topológico, entonces podemos tomar el σ-álgebra más pequeño que contiene a los elementos de <img src="https://render.githubusercontent.com/render/math?math=\large \mathcal{T}">. Los conjuntos de esta σ-álgebra son llamados **conjuntos de Borel**.
