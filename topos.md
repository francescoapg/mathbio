...
- Siendo <img src="https://render.githubusercontent.com/render/math?math=\large \{X_n\}"> un secuencia, si <img src="https://render.githubusercontent.com/render/math?math=\large (\forall n\in\N)(X_n\in\mathcal{A})">, entonces <img src="https://render.githubusercontent.com/render/math?math=\large \bigcup_{n\in\N}{\hspace{0}}X_n\in\mathcal{A}">.
